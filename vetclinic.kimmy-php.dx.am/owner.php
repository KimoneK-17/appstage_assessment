<?php
    ...
    $paginations = ceil($count / $per_page);
        ...
        function deleteOwner(){
            ...
            $sqlQueryPet = "DELETE FROM pet WHERE account_id = ?";
            $stmtpet = $this->conn->prepare($sqlQueryPet);
        
            $this->account_id=htmlspecialchars(strip_tags($this->account_id));
        
            $stmtpet->bindParam(1, $this->account_id);
            ...
            if($stmtpet->execute() && $stmt->execute() ){
                return true;
            }
        }
...
Version: 1
Description: hold functions for owner duties
Reason: Original
-->